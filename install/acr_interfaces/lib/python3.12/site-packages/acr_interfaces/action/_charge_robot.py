...
class Metaclass_ChargeRobot_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('acr_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_Goal')
            logger.debug(
...
class Metaclass_ChargeRobot_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ChargeRobot_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ChargeRobot_Feedback(metaclass=Metaclass_ChargeRobot_Feedback):
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                'Invalid arguments passed to constructor: %s' % \
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.current_percent = kwargs.get('current_percent', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.current_percent != other.current_percent:
            return False
        return True
    ...
    def current_percent(self):
        """Message field 'current_percent'."""
        return self._current_percent

    @current_percent.setter
    def current_percent(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'current_percent' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'current_percent' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class Metaclass_ChargeRobot_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from acr_interfaces.action import ChargeRobot
...
class ChargeRobot_SendGoal_Request(metaclass=Metaclass_ChargeRobot_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'acr_interfaces/ChargeRobot_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from acr_interfaces.action._charge_robot import ChargeRobot_Goal
...
class Metaclass_ChargeRobot_SendGoal_Event(type):
    """Metaclass of message 'ChargeRobot_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__charge_robot__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__charge_robot__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__charge_robot__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__charge_robot__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__charge_robot__send_goal__event
...
class ChargeRobot_SendGoal_Event(metaclass=Metaclass_ChargeRobot_SendGoal_Event):
    """Message class 'ChargeRobot_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<acr_interfaces/ChargeRobot_SendGoal_Request, 1>',
        'response': 'sequence<acr_interfaces/ChargeRobot_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from acr_interfaces.action import ChargeRobot_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ChargeRobot_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ChargeRobot_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from acr_interfaces.action import ChargeRobot_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ChargeRobot_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ChargeRobot_SendGoal_Response'"
...
class Metaclass_ChargeRobot_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from acr_interfaces.action import _charge_robot
            ...
            if _charge_robot.Metaclass_ChargeRobot_SendGoal_Event._TYPE_SUPPORT is None:
                _charge_robot.Metaclass_ChargeRobot_SendGoal_Event.__import_type_support__()


class ChargeRobot_SendGoal(metaclass=Metaclass_ChargeRobot_SendGoal):
    from acr_interfaces.action._charge_robot import ChargeRobot_SendGoal_Request as Request
    from acr_interfaces.action._charge_robot import ChargeRobot_SendGoal_Response as Response
    from acr_interfaces.action._charge_robot import ChargeRobot_SendGoal_Event as Event
...
class ChargeRobot_GetResult_Response(metaclass=Metaclass_ChargeRobot_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'acr_interfaces/ChargeRobot_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from acr_interfaces.action._charge_robot import ChargeRobot_Result
...
class Metaclass_ChargeRobot_GetResult_Event(type):
    """Metaclass of message 'ChargeRobot_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__charge_robot__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__charge_robot__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__charge_robot__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__charge_robot__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__charge_robot__get_result__event
...
class ChargeRobot_GetResult_Event(metaclass=Metaclass_ChargeRobot_GetResult_Event):
    """Message class 'ChargeRobot_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<acr_interfaces/ChargeRobot_GetResult_Request, 1>',
        'response': 'sequence<acr_interfaces/ChargeRobot_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from acr_interfaces.action import ChargeRobot_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ChargeRobot_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ChargeRobot_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from acr_interfaces.action import ChargeRobot_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ChargeRobot_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ChargeRobot_GetResult_Response'"
        self._response = value
...
class Metaclass_ChargeRobot_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _charge_robot.Metaclass_ChargeRobot_GetResult_Event._TYPE_SUPPORT is None:
                _charge_robot.Metaclass_ChargeRobot_GetResult_Event.__import_type_support__()


class ChargeRobot_GetResult(metaclass=Metaclass_ChargeRobot_GetResult):
    from acr_interfaces.action._charge_robot import ChargeRobot_GetResult_Request as Request
    from acr_interfaces.action._charge_robot import ChargeRobot_GetResult_Response as Response
    from acr_interfaces.action._charge_robot import ChargeRobot_GetResult_Event as Event
...
class Metaclass_ChargeRobot_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ChargeRobot_FeedbackMessage(metaclass=Metaclass_ChargeRobot_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'acr_interfaces/ChargeRobot_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['acr_interfaces', 'action'], 'ChargeRobot_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from acr_interfaces.action._charge_robot import ChargeRobot_Feedback
...
class Metaclass_ChargeRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'acr_interfaces.action.ChargeRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ChargeRobot(metaclass=Metaclass_ChargeRobot):
    ...
    from acr_interfaces.action._charge_robot import ChargeRobot_Goal as Goal
    # The result message defined in the action definition.
    from acr_interfaces.action._charge_robot import ChargeRobot_Result as Result
    # The feedback message defined in the action definition.
    from acr_interfaces.action._charge_robot import ChargeRobot_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from acr_interfaces.action._charge_robot import ChargeRobot_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from acr_interfaces.action._charge_robot import ChargeRobot_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from acr_interfaces.action._charge_robot import ChargeRobot_FeedbackMessage as FeedbackMessage

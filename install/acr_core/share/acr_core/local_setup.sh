...
: ${AMENT_CURRENT_PREFIX:="/home/leo/acr_ws/install/acr_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acr_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acr_core/environment/path.sh"
